...
map('n', '<leader>r',  ':e ~/Documents/roku/roku.sh<CR>', {desc = "Open roku.sh"})
map('n', '<leader>c', ':bd<CR>', {desc = "Close buffer"})
map('n', '<leader>;',  ':Nvdash<CR>', {desc = "Open nvDash"})
map('n', '<leader>gh', ':NvCheatsheet<CR>', {desc = "Open cheatsheet"})
map('n', '<leader>gm', ':Telescope git_commits<CR>', {desc = "Telescope git_commits"})
